...
<div class="facebook-section">
    <div class="container">
        <div class="face-top">
            <h5><img src="images/facebook.png"><span>Join Us Know </span></h5>
        </div>
    </div>
</div>
<div class="footer-section">
    <div class="container">
        <div class="footer-grids">
            ...
            <div class="col-md-3 footer-grid">
                <h4>get in touch</h4>
                <p>Vishwas khand,Gomti Nagar</p>
                <p>Lucknow, Uttar Pradesh.</p>
                <p>Telephone : +1 234 567 890</p>
                <p>Telephone : +1 234 567 890</p>
                <p>FAX : + 1 234 567 890</p>
                <p>E-mail : <a href="mailto:mastertron399@mail.com"> Mastertron399@mail.com</a></p>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="copy-section">
            <p>&copy; 2020 CED Hosting. All rights reserved | Design by Sumit Kumar Pandey</a></p>
        </div>
    </div>
</div>
<!---footer--->
